...
namespace Lucene.Net.Support
{
    ...
    public class AppSettings
    {
        ...
        public static int Get(System.String key, int defValue)
        {
            ...
            int theValue = preferences.GetInt(key, defValue);
        ...
        public static long Get(System.String key, long defValue)
        {
            ...
            var preferences = PreferenceManager.GetDefaultSharedPreferences(Application.Context);
            long theValue = preferences.GetLong(key, defValue);
            settings[key] = theValue;
        ...
        public static System.String Get(System.String key, System.String defValue)
        {
            ...
            var preferences = PreferenceManager.GetDefaultSharedPreferences(Application.Context);
            System.String theValue = preferences.GetString(key, defValue);
            settings[key] = theValue;
        ...
        public static bool Get(System.String key, bool defValue)
        {
            ...
            var preferences = PreferenceManager.GetDefaultSharedPreferences(Application.Context);
            bool theValue = preferences.GetBoolean(key, defValue);
            settings[key] = theValue;
